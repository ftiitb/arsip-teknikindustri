...
/**==========================================================================================**/
	...
	var statUser = new Ext.Toolbar.TextItem((username=='')?'No User Login':' user: '+username);
	var detpaneHeight=150;
	if (userid>1){
		detpaneHeight=110; 
	}
	var detailsPanel = {
	...
	function renderIkon(val) {
		if(val){
			return '<a href="' + val + '" target="_blank"><img src="images/icon/script_go.png"></a>';
		}else{
			return '<img src="images/icon/script_error.png">';
		}
	}
